...
INSERT OR IGNORE INTO StartBiasNegatives
		...
		VALUES	
		('CIVILIZATION_NORWAY',						'FEATURE_JUNGLE',						1),
		('CIVILIZATION_NORWAY',						'TERRAIN_TUNDRA',						5),
		('CIVILIZATION_RUSSIA',						'FEATURE_JUNGLE',						1),
		('CIVILIZATION_SCYTHIA',					'FEATURE_JUNGLE',						5),		
...
INSERT OR IGNORE INTO StartBiasCustom
		...
		VALUES	
		('CIVILIZATION_RUSSIA',						'CUSTOM_KING_OF_THE_NORTH'),
