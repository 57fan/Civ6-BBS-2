...
function NewBBS()
   ...
   for i = 1, PlayerManager.GetAliveMinorsCount() do
      ...
      minorAll[minorCount] = {index = i, civName = civName, minor = minorList[i], biases = minorBiases[i], spawnX = -1, spawnY = -1};
   ...
   for i = 0, mapXSize - 1 do
      ...
      for j = 0, mapYSize - 1 do 
         ...
         if (mapSpawnable[iIndex][jIndex]) then -- We already have eliminated a lot of forbidden spawns
            ...
            if (mapTerrainCode[iIndex][jIndex] >= 15 and mapFeatureCode[iIndex][jIndex] == -1 and mapResourceCode[iIndex][jIndex] == -1) then--If no maori, we can expedite things and not analyse water tiles
               -- Maori code --
